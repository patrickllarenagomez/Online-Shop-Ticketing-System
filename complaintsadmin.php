...
<div class="col-md-10 content">
		    ...
		    <?php 
		    	...
		    	$getdatafromforum = "SELECT * FROM forum WHERE assignedTo = '$username'";
		    ...
		    ?>
		      ...
		      <tr>
		        ...
		        <td><a href="replytocomplaintadmin.php?id=<?php echo $getdatafromforumresultrow['forumID']?>">Reply</a><a href="closeticket.php?id=<?php echo $getdatafromforumresultrow['forumID']?>"><?php echo ' | ';?>Close</a></td>
