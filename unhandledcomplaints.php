...
<div class="col-md-10 content">
		    ...
		    <?php 
		    	...
		    	$getdatafromforum = "SELECT * FROM forum WHERE assignedTo = '' AND status = 'OPEN'";
		    ...
		    ?>
		      ...
		      <tr>
		        ...
		        <td><a href="replytocomplaintadmin.php?id=<?php echo $getdatafromforumresultrow['forumID']?>">Reply</a><?php echo ' | '?><a href="closeticket.php?id=<?php echo $getdatafromforumresultrow['forumID']?>">Close</a></td>
